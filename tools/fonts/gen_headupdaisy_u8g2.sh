...
TTF_URL="https://hicchicc.github.io/00ff/x14y24pxHeadUpDaisy.ttf"
TTF_PATH="${ROOT_DIR}/tools/font_assets/x14y24pxHeadUpDaisy.ttf"
MAP_PATH="${TOOLS_DIR}/headupdaisy_subset.map"
...
emit_header() {
  ...
  echo '#endif'
  echo ''
  echo '// Generated by tools/fonts/gen_headupdaisy_u8g2.sh'
  echo ''
}

generate_font() {
  local px="$1"
  local bdf_path="${CACHE_DIR}/x14y24pxHeadUpDaisy_${px}.bdf"
  local tmp_out="${CACHE_DIR}/font_${px}.c"
  local font_name="$2"
  local out_cpp="$3"
...
generate_font 16 "fontHeadUpDaisy14x16_data" "${ROOT_DIR}/components/Display/src/font_headupdaisy14x16.cpp"
generate_font 8 "fontHeadUpDaisy14x8_data" "${ROOT_DIR}/components/Display/src/font_headupdaisy14x8.cpp"
