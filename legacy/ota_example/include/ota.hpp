...
public:
  void main(void) {
    ...
    if (err == ESP_ERR_NVS_NO_FREE_PAGES ||
      ...
      // initialization to fail. 2.NVS partition contains data in new format and
      // cannot be recognized by this version of code. If this happens, we erase
      // NVS partition and initialize NVS again.
